...
public class GameSteps {
    ...
    public void check_shields(String playerID, int shields){
        ...
        for(String playerId: players){
            Player player = selectPlayer(playerId);
            Assertions.assertEquals(shields,player.getShields());
        }
    ...
    public void check_hand(String playerID, String hand){
        ...
        Assertions.assertTrue(player.getHand().toString().contains(hand));
    ...
    public void check_hand_size(String playerID, int amount){
        ...
        Assertions.assertEquals(amount,player.getHand().size());
    }
    ...
    public void quest_end_no_winner(){
        ...
        Assertions.assertEquals(0, game.getWinners().size()); //ensure no winners
        Assertions.assertFalse(game.questing); //check that the quest properly ended, aka not questing
    }
    ...
    public void P1_no_F5(){
        ...
        Assertions.assertFalse(game.P1.getHand().toString().contains("F5"));
    }
    ...
    public void P1_new_cards(){
        ...
        Assertions.assertEquals(12,game.P1.getHand().size());
    ...
    public void determined_as_winner(String playerID) {
        ...
        for(String winner: winners){
            ...
            Assertions.assertTrue(game.getWinners().contains(player));
        }
    }

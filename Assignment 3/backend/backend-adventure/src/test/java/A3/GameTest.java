...
class GameTest {
    ...
    @Test
    @DisplayName("Check Adventure A3.Deck is 100 Cards")
    void RESP01_test_01() {
        Game game = new Game();
        Assertions.assertEquals(100, game.getAdventureDeck().deckSize());
    }

    @Test
    @DisplayName("Check Adventure A3.Deck correctly assigned the 50 foe and 50 weapon cards")
    void RESP01_test_02() {
        Game game = new Game();
        Assertions.assertEquals(100, game.getAdventureDeck().deckSize());
...
// Array to hold all Adventure Cards
        ...
        for (Card card : adventureCards) {
            Assertions.assertEquals(card.getAmount(), game.countOccurrence(game.getAdventureDeck(), card));
            //the get amount on the card should match the actual amount setup by the deck
        }
    }

    @Test
    @DisplayName("Check Event A3.Deck correctly assigned the 12Q cards and 5E cards")
    void RESP01_test_03() {
        Game game = new Game();
        ...
        for (Card card : cards) {
            Assertions.assertEquals(card.getAmount(), game.countOccurrence(game.getEventDeck(), card));
            //the get amount on the card should match the actual amount setup by the deck
        }
    }
    ...
    void RESP02_test_02() {
        Game game = new Game();
        game.distributeAdventureCards();
        Assertions.assertEquals(52, game.getAdventureDeck().deckSize());
    }
    ...
    void RESP04_test_01() {
        ...
        Assertions.assertTrue(game.getWinners().contains(game.P1));
        Assertions.assertTrue(game.checkWinners());
    }
    ...
    void RESP05_test_02() {
        ...
        Assertions.assertTrue(game.getEventDeck().getDiscard().contains(expectedCard));
    ...
    void RESP06_test_01() {
        ...
        Assertions.assertEquals(0, game.P1.getShields());
    ...
    void RESP07_test_01() {
        ...
        Assertions.assertEquals(0, game.P1.getHand().size());
        ...
        Assertions.assertEquals(2, game.P1.getHand().size());
    }
    ...
    void RESP07_test_02() {
        ...
        Assertions.assertEquals(0, game.P1.getHand().size());
        Assertions.assertEquals(0, game.P2.getHand().size());
        Assertions.assertEquals(0, game.P3.getHand().size());
        Assertions.assertEquals(0, game.P4.getHand().size());
        ...
        Assertions.assertEquals(2, game.P1.getHand().size());
        Assertions.assertEquals(2, game.P2.getHand().size());
        Assertions.assertEquals(2, game.P3.getHand().size());
        Assertions.assertEquals(2, game.P4.getHand().size());
    }
    ...
    void RESP08_test_02() {
        ...
        assertTrue(output.contains(expectedHandOutput), "A3.Player's hand output does not match expected.");
    }
    ...
    void RESP09_test_04() {
        ...
        Assertions.assertEquals(1, game.getAdventureDeck().discardSize());
    ...
    void RESP10_test_01() {
        ...
        Assertions.assertEquals(originalPlayer, game.players[game.currentPlayerNum]);
        ...
        Assertions.assertEquals(game.P2, currentPlayer);
    }
    ...
    void RESP11_test_01() {
        ...
        assertTrue(output.contains("Hand: [test1, test1, test1, test1, test1, test2, test2, test2, test2, test2]"),
                "A3.Player's hand was not displayed correctly at the beginning of the turn.");
    }
    ...
    void RESP12_test_01() {
        ...
        Assertions.assertTrue(game.getSponsoringPlayer().getID().equals(game.P2.getID()));
    }
    ...
    void RESP13_test_02() {
        ...
        Assertions.assertTrue(deck.getDiscard().contains(expectedCard));
    ...
    public void RESP18_test_01() {
        ...
        Assertions.assertTrue(game.isStageGreater(previousStage, currentStage));
    }
    ...
    public void RESP18_test_02() {
        ...
        Assertions.assertFalse(game.isStageGreater(previousStage, currentStage));
    }
    ...
    public void RESP18_test_03() {
        ...
        Assertions.assertFalse(game.handleQuitInput(1, stages, true));
    }
    ...
    public void RESP21_test_01() {
        ...
        Assertions.assertEquals(4, game.getAdventureDeck().getDiscard().size()); //ensure discard pile is still updated
    ...
    public void RESP25_test_01() {
        ...
        Assertions.assertEquals(40, game.calculateTotalValue(stages.get(0)));
    }
    ...
    public void RESP25_test_02() {
        ...
        Assertions.assertFalse(game.P4.isParticipating()); //ensure not participating
...
//n, n, y, 2, quit, y, 3, quit
        ...
        Assertions.assertEquals(2,game.P4.getShields()); //won a quest with 2 stages
...
//n, n, y, 2, quit, y, 3, quit
        ...
        Assertions.assertEquals(0,game.P4.getShields()); //won a quest with 2 stages
    ...
    public void RESP27_test_01() {
        ...
        Assertions.assertEquals(4,game.getAdventureDeck().discardSize());
    ...
    public void RESP27_test_02() {
        ...
        Assertions.assertEquals(5,game.getAdventureDeck().discardSize());
        Assertions.assertTrue(game.getAdventureDeck().getDiscard().contains(Excalibur));
...
//n,n,y,2,quit,y,quit
        ...
        Assertions.assertEquals(6,game.P1.getHand().size()); //hand should be 6, quest is built with 4 cards and there are 2 stages
    ...
    public void RESP28_test_02() {
        ...
        Assertions.assertEquals(12,game.P1.getHand().size()); //hand should be 6, quest is built with 4 cards and there are 2 stages
    }
    @Test
    public void A_TEST_JP_scenario(){
        ...
        Assertions.assertTrue(game.P1.getHand().toString().contains("[F5, F10, F15, F15, F30, Horse, Battle Axe, Battle Axe, Lance]"), "P1 hand incorrectly displayed");
        Assertions.assertEquals(0, game.P1.getShields());

        Assertions.assertEquals(0, game.P3.getShields());
        Assertions.assertTrue(game.P3.getHand().toString().contains("[F5, F5, F15, F30, Sword]"), "P3 hand incorrectly displayer");

        Assertions.assertEquals(4,game.P4.getShields());
        Assertions.assertTrue(game.P4.getHand().toString().contains("[F15, F15, F40, Lance]"), "P4 hand incorrectly displayer");

        Assertions.assertEquals(12,game.P2.getHand().size());
